...
`README.md` created with rationale, features, key bindings diagram (from `keybindings.md`), installation, and attribution. Screenshot omitted — to be added as a separate change. PFL removed from features (not practically useful without separate output channels). Rationale wording lightly edited by user during review.
